...
contract EtheriaWrapper0pt9 is Ownable, ERC721 {
    ...
    //      unwanted offers in the offer system. Call etheria.rejectOffer(col, row) until the arrays are completely empty.
